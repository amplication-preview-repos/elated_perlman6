...
@InputType()
class AnnouncementCreateNestedManyWithoutUsersInput {
...
export { AnnouncementCreateNestedManyWithoutUsersInput as AnnouncementCreateNestedManyWithoutUsersInput };
