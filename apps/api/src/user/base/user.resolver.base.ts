...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [UserRanking], { name: "userRankings" })
  @nestAccessControl.UseRoles({
  ...
  async findUserRankings(
    ...
    const results = await this.service.findUserRankings(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [UserOnboarding], { name: "userOnboardings" })
  @nestAccessControl.UseRoles({
  ...
  async findUserOnboardings(
    ...
    const results = await this.service.findUserOnboardings(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [TransactionsPortugueseCoins], {
    name: "transactionsPortugueseCoinsItems",
  })
  @nestAccessControl.UseRoles({
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [TransactionsHonorGlory], {
    name: "transactionsHonorGlories",
  })
  @nestAccessControl.UseRoles({
  ...
  async findTransactionsHonorGlories(
    ...
    const results = await this.service.findTransactionsHonorGlories(
      parent.id,
      args
    );
